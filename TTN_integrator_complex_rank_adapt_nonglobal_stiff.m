function [Y1,C0_tau_hat,C1_tau_hat] = TTN_integrator_complex_rank_adapt_nonglobal_stiff(tau,Y0,F_tau,t0,t1,A,d,r_min,l_basis)
...
%         Y1_i = RK_4_nonglobal(Y0_i,tau{i},F_tau_i,t0,t1,A,d);
        ...
        [Y1_i,C0_taui_hat] = TTN_integrator_complex_rank_adapt_nonglobal_stiff(tau{i},Y0_i,F_tau_i,t0,t1,A,d,r_min,l_basis);
    end
...
Y1{end} = Lanczos_tensor(C0,F_ODE,Y1(1:m),F_tau,t0,t1,A,d,l_basis);
C1_tau_hat = Y1{end};
