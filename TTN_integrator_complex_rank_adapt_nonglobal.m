function [Y1,C0_tau_hat,C1_tau_hat] = TTN_integrator_complex_rank_adapt_nonglobal(tau,Y0,F_tau,t0,t1,A,d,r_min)
...
for i=1:m
    ...
    if 0 == iscell(tau{i})    % if \tau_i = l, l \in L
        ...
        [Y1_i,C0_taui_hat] = TTN_integrator_complex_rank_adapt_nonglobal(tau{i},Y0_i,F_tau_i,t0,t1,A,d,r_min);
    end
